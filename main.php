				...
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							...
							margin-bottom:50px;">NextStep Career Career Guidance System</h1>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to NextStep Career</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">NextStep Career</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
